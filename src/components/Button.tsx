    ...
    <button
      ...
      className={clsx(
        ...
        variant === 'text' && [
          ...
          color === 'red' &&
            'bg-transparent hover:bg-gray-100 disabled:hover:bg-transparent active:bg-transparent disabled:active:bg-transparent border-transparent text-red-500',
        ],
        variant === 'contained' && [
          color === 'black' &&
          ...
          color === 'red' &&
            'bg-red-500 hover:bg-red-700 disabled:hover:bg-red-500 active:bg-red-500 disabled:active:bg-red-500 text-white',
        ],
        variant === 'outlined' && [
          color === 'black' && [
          ...
          color === 'red' && [
            'bg-white hover:bg-gray-100 disabled:hover:bg-white active:bg-white disabled:active:bg-white text-red-500',
            'border-red-500 hover:border-red-600 disabled:hover:border-red-500 active:border-red-500 disabled:active:border-red-500',
          ],
        ],
        className
      )}>
